...
| Case | Focus | Primary claim tested |
| --- | --- | --- |
| [001](case-001-prompt-injection-tool-abuse/README.md) | Prompt injection → tool abuse | Influence, authorization, tool execution, and state change can be reconstructed. |
| [002](case-002-persistent-memory-poisoning/README.md) | Persistent memory poisoning | Removing the original source does not contain durable derived influence. |
| [003](case-003-delegated-credential-containment/README.md) | Delegated credential containment failure | Isolating the parent agent does not contain inherited authority or child workflows. |
